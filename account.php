  ...
  <div class="row">
    ...
    <div class="col-md-8">
      ...
      <ul class="list-group">
          ...
          <?php
          $query = "SELECT account_sm.sm_url, account_sm.fk_sm_type, account_sm.fk_user_id, social_media.id, social_media.sm_name
          ...
          <?php
          $query = "SELECT fk_user_id, game_name, game_url FROM account_games
          WHERE fk_user_id = ".htmlentities($_SESSION['user_id']).";";
          $stmt = $mysqli->query($query);
          while($row = $stmt->fetch_assoc()) {
